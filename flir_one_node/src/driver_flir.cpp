...
namespace driver_flir
{
  ...
  DriverFlir::DriverFlir( ros::NodeHandle nh,
    ...
    // thermal_pub_ = priv_nh.advertise<std_msgs::UInt32MultiArray>("thermal/temperature", 1);
  }
...
// 22. 07. 25
    ...
    // std_msgs::UInt32MultiArray thermal_data;
    // // thermal_data.data = pipixx_copy;
    // thermal_data.data.assign(pix_copy,pix_copy + 160* 120);

    
    // image_pub_.publish(out_msg.toImageMsg());
    // thermal_pub_.publish(thermal_data);
