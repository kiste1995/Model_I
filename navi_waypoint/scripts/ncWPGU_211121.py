    ...
    def run(self):
        ...
        if self.bRunFlag == True:
            ...
            if self.bRunFlag == True:
                ...
                #     self.dsrtraj_runstat.emit("Complete moving HDI Trjaectory #5...")   
...
class MyWindow(QMainWindow, form_class):
    ...
    def onCRDIBtn(self):
        ...
        if self.bCRDIRun == False:
            ...
            self.naviCRDI_th.setCRDIfwf.connect(self.setCRDIFrontWF)
            self.naviCRDI_th.setCRDIbwf.connect(self.setCRDIRearWF)
