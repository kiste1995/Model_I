    ...
    def navi_Process(self):
        ...
        if self.HDIRun[0] == '0' and self.bRunFlag == True:        
            ...
            if bErrFlag == False and self.bRunFlag == True: 
                ...
                print("[Device1] Send topic [Run Trajectory 1]")
                ...
                if self.bRunFlag == True:
                    ...
                    print("[Device1] Send topic [Run Trajectory 2]")
        ...
        if self.HDIRun[1] == '0' and self.bRunFlag == True:   
            ...
            if bErrFlag == False and self.bRunFlag == True:
                ...
                print("[Device2] Send topic [Run Trajectory 1]")
                ...
                if self.bRunFlag == True:
                    ...
                    print("[Device2] Send topic [Run Trajectory 2]")
        ...
        #             self.navi_runstat.emit("Stop lobbypos1 HDI process...")
        ...
        #         if self.bRunPauseFlag == True:
        #             self.navi_runstat.emit("Pause lobbypos1 HDI process...")
        #             while self.bRunPauseFlag:
        #                 if self.bRunPauseFlag is False:
        #                     self.navi_runstat.emit("Restart lobbypos1 HDI process...")
        #                     break
        ...
        #                 self.navi_runstat.emit("Restart lobbypos1")
        ...
        #                 self.navi_runstat.emit("Error(WARNNRGTO) lobbypos1")

        #             break

        #         if self.naviStatus == NavigationControlStatus.ERRGTGF:
        #             self.navi_runstat.emit("Error(ERRGTGF) lobbypos1")
        ...
        #             self.navi_runstat.emit("Stop lobbypos2 HDI process...")
        ...
        #         if self.bRunPauseFlag == True:
        #             self.navi_runstat.emit("Pause lobbypos2 HDI process...")
        #             while self.bRunPauseFlag:
        #                 if self.bRunPauseFlag is False:
        #                     self.navi_runstat.emit("Restart lobbypos2 HDI process...")
        #                     break
        ...
        #                 self.navi_runstat.emit("Restart lobbypos2")
        ...
        #                 self.navi_runstat.emit("Error(WARNNRGTO) lobbypos2")

        #             break

        #         if self.naviStatus == NavigationControlStatus.ERRGTGF:
        #             self.navi_runstat.emit("Error(ERRGTGF) lobbypos2")
        ...
        if self.HDIRun[2] == '0' and self.bRunFlag == True:   
            ...
            if bErrFlag == False and self.bRunFlag == True:
                ...
                print("[Device3] Send topic [Run Trajectory 1]")

                print("===> Send topic [Run Trajectory 1]")
                ...
                if self.bRunFlag == True:
                    ...
                    print("[Device3] Send topic [Run Trajectory 2]")
        ...
        if self.HDIRun[3] == '0' and self.bRunFlag == True:   
            ...
            if bErrFlag == False and self.bRunFlag == True:
                ...
                print("[Device4] Send topic [Run Trajectory 1]")
                ...
                if self.bRunFlag == True:
                    ...
                    print("[Device4] Send topic [Run Trajectory 2]")
        ...
        # if (self.HDIRun[4] == '0' or self.HDIRun[5] == '0') and self.bRunFlag == True:   
        #     self.naviStatus = NavigationControlStatus.IDLING

        #     os.system("python3 ~/bin/target_term -run 10 rosservice call /move_base/clear_costmaps \"{}\"  ")

        #     self.gotoWayPoint("lobbypos3")
        ...
        #             self.navi_runstat.emit("Stop lobbypos3 HDI process...")
        ...
        #         if self.bRunPauseFlag == True:
        #             self.navi_runstat.emit("Pause lobbypos3 HDI process...")
        #             while self.bRunPauseFlag:
        #                 if self.bRunPauseFlag is False:
        #                     self.navi_runstat.emit("Restart lobbypos3 HDI process...")
        #                     break
        ...
        #                 self.navi_runstat.emit("Restart lobbypos3")
        ...
        #                 self.navi_runstat.emit("Error(WARNNRGTO) lobbypos3")

        #             break

        #         if self.naviStatus == NavigationControlStatus.ERRGTGF:
        #             self.navi_runstat.emit("Error(ERRGTGF) lobbypos3")
        ...
        # =================================
        # Hallow Disinfection Process #9
        # =================================

        if self.HDIRun[5] == '0' and self.bRunFlag == True: 
            self.trajStatus = ZBDSRTrajStatus.IDLING
            self.naviStatus = NavigationControlStatus.IDLING
            ...
            if bErrFlag == False and self.bRunFlag == True:
                ...
                print("[Device5] Send topic [Run Trajectory 3]")
                ...
                if self.bRunFlag == True:
                    ...
                    print("[Device5] Send topic [Run Trajectory 4]")
        ...
        # =================================
        # Hallow Disinfection Process #10
        # =================================

        if self.HDIRun[6] == '0' and self.bRunFlag == True: 
            self.trajStatus = ZBDSRTrajStatus.IDLING
            self.naviStatus = NavigationControlStatus.IDLING
            ...
            if bErrFlag == False and self.bRunFlag == True:
                ...
                print("[Device6] Send topic [Run Trajectory 3]")
                ...
                if self.bRunFlag == True:
                    ...
                    print("[Device6] Send topic [Run Trajectory 4]")
