...
# yaml_fname = rootdir +"/config/HDIWP16.yaml" #Hallow_pose (last)
# yaml_fname = rootdir +"/config/HDIWP55.yaml" #Huster office (3Box)
# yaml_fname = rootdir +"/config/HDIWP77.yaml" #dgcity_4f_1
# yaml_fname = rootdir +"/config/HDIWP88.yaml" #dgcity_4f
...
class Thread_HollowDisfection(QThread):
    ...
    def navi_Process(self):
        ...
        # ======================================
        # Hallow Disinfection Process return #1_2
        # ======================================
        ...
        # ======================================
        # Hallow Disinfection Process return #2_2
        # ======================================
        if self.bRunFlag == True:   
            self.naviStatus = NavigationControlStatus.IDLING
            ...
            while True:
                ...
                if self.bRunFlag == False:
                    ...
                    self.navi_runstat.emit("Stop ret device2_2 HDI process...")
                ...
                if self.bRunPauseFlag == True:
                    self.navi_runstat.emit("Pause ret device2_2 HDI process...")
                    while self.bRunPauseFlag:
                        if self.bRunPauseFlag is False:
                            self.navi_runstat.emit("Restart ret device2_2 HDI process...")
                            break
                ...
                if self.naviStatus == NavigationControlStatus.COMPLETED:
                    ...
                    print("Arrived at ret device2_2...")
                    break
                ...
                if self.naviStatus == NavigationControlStatus.WARNNRGTO:
                    ...
                    if runcnt <= self.RepCnt:
                        ...
                        self.navi_runstat.emit("Restart ret device2_2")

                        print("Restart ret Device2_2 : " + str(runcnt))
                        ...
                        self.navi_runstat.emit("Error(WARNNRGTO) ret device2_2")

                    break

                if self.naviStatus == NavigationControlStatus.ERRGTGF:
                    self.navi_runstat.emit("Error(ERRGTGF) device2_2")
        ...
        # ======================================
        # Hallow Disinfection Process return #5_2
        # ======================================
        ...
        if self.bRunFlag == True:   
            ...
            while True:
                ...
                if self.bRunFlag == False:
                    ...
                    self.navi_runstat.emit("Stop ret device5_2 HDI process...")
                ...
                if self.bRunPauseFlag == True:
                    self.navi_runstat.emit("Pause ret device5_2 HDI process...")
                    while self.bRunPauseFlag:
                        if self.bRunPauseFlag is False:
                            self.navi_runstat.emit("Restart ret device5_2 HDI process...")
                            break
                    
                        sleep(0.1)            
        
                if self.naviStatus == NavigationControlStatus.COMPLETED:
                    print("Arrived at ret device5_2...")
                    break
                ...
                if self.naviStatus == NavigationControlStatus.WARNNRGTO:
                    ...
                    if runcnt <= self.RepCnt:
                        ...
                        self.navi_runstat.emit("Restart ret device5_2")

                        print("Restart ret device5_2 : " + str(runcnt))
                        ...
                        self.navi_runstat.emit("Error(WARNNRGTO) ret device5_2")

                    break

                if self.naviStatus == NavigationControlStatus.ERRGTGF:
                    self.navi_runstat.emit("Error(ERRGTGF) ret device5_2")
        ...
        # ======================================
        # Hallow Disinfection Process return #6_2
        # ======================================
        ...
        if self.bRunFlag == True:   
            ...
            while True:
                ...
                if self.bRunFlag == False:
                    ...
                    self.navi_runstat.emit("Stop ret device6_2 HDI process...")
                ...
                if self.bRunPauseFlag == True:
                    self.navi_runstat.emit("Pause ret device6_2 HDI process...")
                    while self.bRunPauseFlag:
                        if self.bRunPauseFlag is False:
                            self.navi_runstat.emit("Restart ret device6_2 HDI process...")
                            break
                    
                        sleep(0.1)            
        
                if self.naviStatus == NavigationControlStatus.COMPLETED:
                    print("Arrived at ret device6_2...")
                    break
                ...
                if self.naviStatus == NavigationControlStatus.WARNNRGTO:
                    ...
                    if runcnt <= self.RepCnt:
                        ...
                        self.navi_runstat.emit("Restart ret device6_2")

                        print("Restart ret device6_2 : " + str(runcnt))
                        ...
                        self.navi_runstat.emit("Error(WARNNRGTO) ret device6_2")

                    break

                if self.naviStatus == NavigationControlStatus.ERRGTGF:
                    self.navi_runstat.emit("Error(ERRGTGF) ret device6_2")
