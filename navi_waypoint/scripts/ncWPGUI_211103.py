...
yaml_fname = rootdir +"/config/HDIWP8.yaml"
...
class Thread_ReturnToCharingStation(QThread):
    navi_runstat = pyqtSignal(str)
    
    def __init__(self, parent = None):
        super(Thread_ReturnToCharingStation, self).__init__(parent)
        self.working = True
...
class Thread_ConfRoomDisfection(QThread):
    ...
    def run(self):
        ...
        while True:
            ...
            if self.naviStatus == NavigationControlStatus.COMPLETED:
            #if self.naviStatus == NavigationControlStatus.TRJCOMPLETED:
    ...
    def navi_Process(self):
        ...
        if self.HDIRun[0] == '0':        
            ...
            if bErrFlag == False: 
                ...
                self.dsrtraj_runstat.emit("Complete moving Trjaectory #1...")
                ...
                print("Complete moving Trjaectory #2...")
        ...
        if self.HDIRun[1] == '0':   
            ...
            if bErrFlag == False:
                ...
                print("Complete moving Trjaectory #1...")
        ...
        if self.HDIRun[4] == '0': 
            ...
            if bErrFlag == False:
                ...
                print("Skip moving Trjaectory #4...")   
