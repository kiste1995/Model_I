...
function startSubscribers() {
    ...
    // name : options['robotBatteryTopic'],
	messageType: 'BatteryInformationMsgs',
	...
	var color =	getBatteryColor(msg.SOC);
    // console.log('Battery msg ' + msg);
...
function getBatteryColor(value) {
    if (value >= 0 && value <= 40) return '#FF0000';
    if (value > 40 && value <= 60) return '#FFFF00';
